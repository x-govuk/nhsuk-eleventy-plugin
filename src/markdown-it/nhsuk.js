...
/**
 * Adds NHS.UK typography classes to blockquotes, headings, paragraphs, links,
 ...
 */
export function markdownNhsUk(md, pluginOptions = {}) {
  // Merge options
  ...
  md.renderer.rules.heading_open = (tokens, idx, options, env, self) => {
    ...
    tokens[idx].attrPush(['class', `nhsuk-heading-${modifier}`])
  ...
  addClassesToRule(
    md,
    'blockquote_open',
    'nhsuk-inset-text nhsuk-u-margin-left-0'
  )

  // Block code (indented, not fenced)
  addClassesToRule(md, 'code_block', 'nhsuk-inset-text nhsuk-u-margin-left-0')

  // Inline code
  addClassesToRule(md, 'code_inline', 'app-code app-code--inline')

  // Paragraphs
  addClassesToRule(md, 'paragraph_open', 'nhsuk-body')

  // Links
  addClassesToRule(md, 'link_open', 'nhsuk-link')

  // Lists
  addClassesToRule(md, 'bullet_list_open', 'nhsuk-list nhsuk-list--bullet')
  addClassesToRule(md, 'ordered_list_open', 'nhsuk-list nhsuk-list--number')
  ...
  // Tables
  addClassesToRule(md, 'table_open', 'nhsuk-table')
  addClassesToRule(md, 'thead_open', 'nhsuk-table__head')
  addClassesToRule(md, 'tbody_open', 'nhsuk-table__body')
  addClassesToRule(md, 'tr_open', 'nhsuk-table__row')
  addClassesToRule(md, 'th_open', 'nhsuk-table__header')
  addClassesToRule(md, 'td_open', 'nhsuk-table__cell')
