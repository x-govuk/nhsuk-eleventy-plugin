...
describe('markdown-it', () => {
  ...
  it('Renders anchor heading permalinks when option enabled', () => {
    ...
    assert.equal(
      result,
      '<h1 id="heading" tabindex="-1" class="nhsuk-heading-xl"><a class="app-link--heading nhsuk-link" href="#heading"><span>Heading</span></a></h1>\n'
    )
  })
  ...
  it('Renders a definition list', () => {
    ...
    assert.match(result, /<dl class="nhsuk-body-m"/)
  })

  it('Renders a figure', () => {
    const result = md().render(`![Alt](# 'Title')`)

    assert.equal(
      result,
      `<figure class="nhsuk-image">\n<img src="#" alt="Alt" class="nhsuk-image__img"><figcaption class="nhsuk-image__caption">\nTitle</figcaption></figure>\n`
    )
  })
  ...
  it('Renders a table of contents', () => {
    ...
    assert.match(result, /<nav class="nhsuk-contents-list"/)
