...
const eleventyNavigationBreadcrumb = [
  {
    ...
    parent: false,
    excerpt:
      'The familiarity of the [NHS.UK Design system](https://service-manual.nhs.uk/design-system) combined with the simplicity of the [Eleventy](https://www.11ty.dev) static site generator.',
    url: '/',
