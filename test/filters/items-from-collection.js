  ...
  it('Converts collection data to items array', () => {
    ...
    assert.deepEqual(result, [
      ...
      },
      {
        ...
        heading: 'Two',
        descriptionHtml:
          '<p class="nhsuk-body-s"><time class="nhsuk-u-secondary-text-color" datetime="2025-08-03T00:00:00.000Z">3 August 2025</time></p><p class="nhsuk-card__description">Description</p>',
        imgURL: '/image.jpg',
