...
| javascripts           | array             | JavaScript files to load on every page. Files must use [JavaScript module format](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules).                    |
